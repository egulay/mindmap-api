...
//        String TimeId = new ObjectId().toString();
        ...
        String thinkingId = new ObjectId().toString();
        ...
        treeStructureRepository.deleteAll()
                ...
                .then(
                        Mono.just("Without heavy processes or Agile").flatMap(label -> treeStructureRepository.save(TreeStructure.builder()
                                .id(agileId)
                                .childrenIds(null)
                                .label(label)
                                .departmentId(departmentId)
                ...
                .then(
                        Mono.just("Taking risk or challenges").flatMap(label -> treeStructureRepository.save(TreeStructure.builder()
                                .id(takingRiskId)
                                .childrenIds(null)
                                .label(label)
                                .departmentId(departmentId)
                ...
                .then(
                        Mono.just("Thinking").flatMap(label -> {
                            List<String> childIds = new ArrayList<String>() {{
                                add(outsideOfBoxId);
                                add(curiosityId);
                                add(courageId);
                ...
                .then(
                        Mono.just("Success stories or Fame").flatMap(label -> treeStructureRepository.save(TreeStructure.builder()
                                .id(successId)
                                .childrenIds(null)
                                .label(label)
                                .departmentId(departmentId)
